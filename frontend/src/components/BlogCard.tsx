            ...
            <div className="border border-slate-200 mb-6 mt-6 cursor-pointer pb-4 border-l-0 border-t-0 border-r-0">
                <div className="flex items-center mb-2">
                    ...
                    <div className="flex justify-center items-center">
                        <p className="text-gray-800 text-sm font-semibold pl-1">
                            {authorname || "Anonymous"}
                        </p>
                        <div className="flex justify-center pl-1 items-center">
                            <Circle />
                        </div>
                        <p className="text-gray-500 pl-1 text-sm">
                            {publishedDate}
                        </p>
                    </div>
                </div>
                ...
                <div
                    className=" text-md font-thin pb-1 truncate"
                    dangerouslySetInnerHTML={{ __html: sanitizedContent }}
                />
                <p className="text-slate-400 text-sm">{`${Math.ceil(
                    content.length / 100
                )} minute(s) to read.`}</p>
            </div>
        </Link>
